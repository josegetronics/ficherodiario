...
public class HojaDatosTresExcel extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"datos3.xlsx\"");

		logDatosTres.info("Iniciando la clase buildExcelDocument");

		List<String> datostres = (List<String>) model.get("crucesUrgentes");
		...
		CellRangeAddress region = new CellRangeAddress(0, datostres.size(), 0, header.length - 1);
