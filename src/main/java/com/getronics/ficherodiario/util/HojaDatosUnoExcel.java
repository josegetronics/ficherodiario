...
@Component("hojaUno.xlsx")
public class HojaDatosUnoExcel extends AbstractXlsxView{

	private Logger logDatosUno = LoggerFactory.getLogger(this.getClass());

	
	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		response.setHeader("Content-Disposition", "attachment; filename=\"datos1.xlsx\"");
		
		logDatosUno.info("Iniciando la clase buildExcelDocument");

		List<String> datosUno = (List<String>) model.get("crucesUrgentes");
